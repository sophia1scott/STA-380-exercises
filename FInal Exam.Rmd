...
```{r, echo=FALSE}
library(RCurl)
green <- read.csv("C:/Users/Sophia Scott/Documents/a.STA 380 MACHINE LEARNING/PART 2/greenbuildings.csv")
green <- na.omit(green)
attach(green)
...
eig.val.twitter
fviz_eig(PCA.twit, addlabels = TRUE, ylim = c(0, 30))
head(var$contrib, 15)

# Contributions of variables to PC1
fviz_contrib(PCA.twit, choice = "var", axes = 1, top = 10)
# Contributions of variables to PC2
fviz_contrib(PCA.twit, choice = "var", axes = 2, top = 10)
...
plot_k9 = clusplot(clean, twitter.k9$cluster, color=T, shade=F, labels=4, lines=0, main="K-means cluster plot")
plot_k9
```
...
naive=naiveBayes(as.factor(author)~.,data=train_class)
...
rf = randomForest(as.factor(author)~.,data=train_class)
CM = table(predict(rf), train_class$author)
...
groceries = scan("C:/Users/Sophia Scott/Documents/a.STA 380 MACHINE LEARNING/PART 2/groceries.txt", what = "", sep = "\n") #9835 items 
